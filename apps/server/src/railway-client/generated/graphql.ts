...
export type CreateDomainMutation = { __typename?: 'Mutation', serviceDomainCreate: { __typename?: 'ServiceDomain', id: string, domain: string } };
...
export type CreateServiceMutation = { __typename?: 'Mutation', serviceCreate: { __typename?: 'Service', id: string, name: string, project: { __typename?: 'Project', id: string, name: string } } };
...
export type StartServiceMutation = { __typename?: 'Mutation', serviceInstanceDeploy: boolean };
...
export type StopServiceMutation = { __typename?: 'Mutation', deploymentRemove: boolean };
...
export type ServiceDeploymentsQuery = { __typename?: 'Query', service: { __typename?: 'Service', id: string, name: string, icon?: string | null, projectId: string, createdAt: any, updatedAt: any, deletedAt?: any | null, templateServiceId?: string | null, templateThreadSlug?: string | null, project: { __typename?: 'Project', id: string, name: string, isPublic: boolean }, deployments: { __typename?: 'ServiceDeploymentsConnection', edges: Array<{ __typename?: 'ServiceDeploymentsConnectionEdge', cursor: string, node: { __typename?: 'Deployment', id: string, status: DeploymentStatus, createdAt: any, updatedAt: any, staticUrl?: string | null, url?: string | null, environmentId: string, canRedeploy: boolean, canRollback: boolean, snapshotId?: string | null, deploymentStopped: boolean, suggestAddServiceDomain: boolean, creator?: { __typename?: 'DeploymentCreator', avatar?: string | null, email: string, name?: string | null } | null } }>, pageInfo: { __typename?: 'PageInfo', hasNextPage: boolean, hasPreviousPage: boolean, startCursor?: string | null, endCursor?: string | null } } } };
...
export type ServicesQuery = { __typename?: 'Query', project: { __typename?: 'Project', id: string, name: string, services: { __typename?: 'ProjectServicesConnection', edges: Array<{ __typename?: 'ProjectServicesConnectionEdge', cursor: string, node: { __typename?: 'Service', featureFlags: Array<ActiveServiceFeatureFlag>, id: string, name: string, project: { __typename?: 'Project', id: string, name: string, isPublic: boolean }, deployments: { __typename?: 'ServiceDeploymentsConnection', edges: Array<{ __typename?: 'ServiceDeploymentsConnectionEdge', node: { __typename?: 'Deployment', id: string, status: DeploymentStatus } }> }, serviceInstances: { __typename?: 'ServiceServiceInstancesConnection', edges: Array<{ __typename?: 'ServiceServiceInstancesConnectionEdge', node: { __typename?: 'ServiceInstance', id: string, domains: { __typename?: 'AllDomains', serviceDomains: Array<{ __typename?: 'ServiceDomain', domain: string, targetPort?: number | null }> }, source?: { __typename?: 'ServiceSource', image?: string | null, repo?: string | null } | null } }> } } }>, pageInfo: { __typename?: 'PageInfo', hasNextPage: boolean, hasPreviousPage: boolean, startCursor?: string | null, endCursor?: string | null } } } };

export type ServiceBasicFragment = { __typename?: 'Service', id: string, name: string };

export type ServiceWithDeploymentFragment = { __typename?: 'Service', featureFlags: Array<ActiveServiceFeatureFlag>, id: string, name: string, project: { __typename?: 'Project', id: string, name: string, isPublic: boolean }, deployments: { __typename?: 'ServiceDeploymentsConnection', edges: Array<{ __typename?: 'ServiceDeploymentsConnectionEdge', node: { __typename?: 'Deployment', id: string, status: DeploymentStatus } }> }, serviceInstances: { __typename?: 'ServiceServiceInstancesConnection', edges: Array<{ __typename?: 'ServiceServiceInstancesConnectionEdge', node: { __typename?: 'ServiceInstance', id: string, domains: { __typename?: 'AllDomains', serviceDomains: Array<{ __typename?: 'ServiceDomain', domain: string, targetPort?: number | null }> }, source?: { __typename?: 'ServiceSource', image?: string | null, repo?: string | null } | null } }> } };

export const ServiceBasicFragmentDoc = gql`
    fragment ServiceBasic on Service {
  id
  name
}
    `;
export const ServiceWithDeploymentFragmentDoc = gql`
...
export const ServicesDocument = gql`
  ...
  project(id: $projectId) {
    ...
    ${ServiceWithDeploymentFragmentDoc}`;
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    createDomain(variables: CreateDomainMutationVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<CreateDomainMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<CreateDomainMutation>({ document: CreateDomainDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'createDomain', 'mutation', variables);
    },
    createService(variables: CreateServiceMutationVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<CreateServiceMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<CreateServiceMutation>({ document: CreateServiceDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'createService', 'mutation', variables);
    },
    deleteService(variables: DeleteServiceMutationVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<DeleteServiceMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<DeleteServiceMutation>({ document: DeleteServiceDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'deleteService', 'mutation', variables);
    },
    startService(variables: StartServiceMutationVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<StartServiceMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<StartServiceMutation>({ document: StartServiceDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'startService', 'mutation', variables);
    },
    stopService(variables: StopServiceMutationVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<StopServiceMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<StopServiceMutation>({ document: StopServiceDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'stopService', 'mutation', variables);
    },
    serviceDeployments(variables: ServiceDeploymentsQueryVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<ServiceDeploymentsQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<ServiceDeploymentsQuery>({ document: ServiceDeploymentsDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'serviceDeployments', 'query', variables);
    },
